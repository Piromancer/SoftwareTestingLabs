...
/**
 * 2. Программный модуль для работы с биномиальной кучей
 * (Logical Representation, http://www.cs.usfca.edu/~galles/visualization/BinomialQueue.html)
 */
...
public class BinomialQueue<AnyType extends Comparable<? super AnyType>>
{
    ...
    public static class BinomialNode<AnyType>
    {
        // Constructors
        ...
        public BinomialNode<AnyType> leftChild;   // Left child
        public BinomialNode<AnyType> nextSibling; // Right child
    }
